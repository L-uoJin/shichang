<?php
/* Smarty version 3.1.30, created on 2018-11-13 00:07:19
  from "F:\webphp\php-7.2.4\www\shichang\admin\smarty\templates\edit.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5be9a537852995_86862285',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '212b3bc8e3e22b1bbee6be48f9e5152f70796fd9' => 
    array (
      0 => 'F:\\webphp\\php-7.2.4\\www\\shichang\\admin\\smarty\\templates\\edit.tpl',
      1 => 1542038812,
      2 => 'file',
    ),
  ),
...
function content_5be9a537852995_86862285 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                  ...
                  <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form role="form" action="controller/edit_product.php" method="post" enctype="multipart/form-data">
                                  <div class="form-group">
                                      <label for="exampleInputName1">菜名</label>
                                      <input type="text" class="form-control" id="exampleInputName1"
                                       name="name"  value="<?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
">
...
">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="exampleInputPrice1"  name="price" value="<?php echo $_smarty_tpl->tpl_vars['product']->value['price'];?>
">
                                  </div>
                                  <div class="form-group">
                                      <label for="exampleInputNumber1">数量</label>
                                      <input type="text" class="form-control" id="exampleInputNumber1"  name="num" value="<?php echo $_smarty_tpl->tpl_vars['product']->value['num'];?>
">
                                  </div>
                                  <div class="form-group">
...
?>
                                         <?php if ($_smarty_tpl->tpl_vars['v']->value['id'] == $_smarty_tpl->tpl_vars['product']->value['cid']) {?>
                                          <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['v']->value['cname'];?>
</option>
                                         <?php } else { ?>
                                             <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
