	...
	<section id="our-team">
		<div class="container">
			<div class="row">
               ...
               {foreach key=key item=item from=$recommend}
				<div class="col-md-3 col-sm-6 h270">
					<div class="team-member">
						...
						<div class="member-info">
							<h4>{$item.name}</h4>
							<span><i class="glyphicon glyphicon-thumbs-up"></i>{$item.zan}</span>
						</div>
					</div>
				</div>
				{/foreach}
				...
				<div class="portfolio-wrapper" >
					<div class="col-md-12">
						<ul class="filter">  			
							...
							<li><a href="#" data-filter=".leaf">{$cate[0]['cname']}</a></li>
							<li><a href="#" data-filter=".root">{$cate[1]['cname']}</a></li>
							<li><a href="#" data-filter=".melon">{$cate[2]['cname']}</a></li>
							<li><a href="#" data-filter=".bean">{$cate[3]['cname']}</a></li>
							<li><a href="#" data-filter=".mushroom">{$cate[4]['cname']}</a></li>
							<li><a href="#" data-filter=".eggplant">{$cate[5]['cname']}</a></li>
						</ul><!--/#portfolio-filter-->

					</div>
					<div class="portfolio-items">	
					<!--豆类-->		
					{foreach item=item from=$data4}
						<div class="col-md-2 col-sm-6 work-grid bean">
							<div class="portfolio-content">
								<img class="img-responsive" src="{$item.img}" alt="">
								<div class="portfolio-overlay">								
									<a href="describe.php?id={$item.id}"><i class="glyphicon glyphicon-shopping-cart"></i></a><h5 style="float:right;">￥{$item.price}<p>{$item.name}</p></h5>			
								</div>
							</div>	
						</div>
						{/foreach}
						<!--瓜类-->		
						{foreach item=item from=$data3}
