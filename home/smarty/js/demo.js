        ...
        tr[i].onclick = function (e) {
            ...
            switch (cls) {
                case 'add': //点击了加号
                    ...
                    getSubtotal(this);
                    arr[$(this).find("#id").val()]=countInout.value;
                    break;
                case 'reduce': //点击了减号
                    if (value > 1) {
                        countInout.value = value - 1;
                ...
                case 'delete': //点击了删除
                    ...
                    if (conf) {
                       ...
                       var  id=$(this).find('#id').val();
                        $.ajax({
                            url: "controller/delshop.php",// 获取自己系统后台用户信息接口
                            data: {"id":id},
                            type: "GET",
                            dataType: "json",
    ...
    $(function () {
      ...
      var arr1=  str.split(",");
        $('#jiesuan').click(function () {
           ...
           {
               if(arr[arr1[i]]==undefined)arr[arr1[i]]=1;
           }
            for(var i=0;i<arr1.length;i++)
            {
               str1+=arr[arr1[i]]+",";
            ...
            window.location.href="order.php?str="+str+'&str1='+str1+"&priceTotal="+priceTotal.innerHTML;
          // open('settle?s='+s+'&str1='+str1,'_blank','width=420 height=220',false);
        })
    })
